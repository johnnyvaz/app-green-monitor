...
export function fieldSorter(fields, dsSortAs = {}) {
  const dir = []
  let i
...
export function fieldFilter(items, filterFields) {
  // Filter it by field
...
export function findAny(dsSearchIn, dsSearchAs, obj, str) {
...
export default { MORE_PAGES, debounce, isEmptyObject, createPagingRange, fieldSorter, fieldFilter, findAny }
